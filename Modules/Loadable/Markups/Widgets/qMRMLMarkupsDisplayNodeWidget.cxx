...
void qMRMLMarkupsDisplayNodeWidgetPrivate::init()
{
  ...
  QObject::connect(this->connectorLineVisibilityCheckBox, SIGNAL(toggled(bool)),
      q, SLOT(setLabelConnectorLineVisibility(bool)));
...
void qMRMLMarkupsDisplayNodeWidget::updateWidgetFromMRML()
{
  ...
  double labelConnectorLineScale = markupsDisplayNode->GetLabelConnectorLineScale();
  // make sure that the slider can accommodate this scale
  if (labelConnectorLineScale > d->connectorLineScaleSliderWidget->maximum())
  {
      d->connectorLineScaleSliderWidget->setMaximum(labelConnectorLineScale);
  }
  d->connectorLineScaleSliderWidget->setValue(labelConnectorLineScale);
  d->PointLabelsVisibilityCheckBox->setChecked(markupsDisplayNode->GetPointLabelsVisibility());

  d->connectorLineVisibilityCheckBox->setChecked(markupsDisplayNode->GetLabelConnectorLineVisibility());
...
//------------------------------------------------------------------------------
void qMRMLMarkupsDisplayNodeWidget::setLabelConnectorLineVisibility(bool visible)
{
    Q_D(qMRMLMarkupsDisplayNodeWidget);
    ...
    d->MarkupsDisplayNode->SetLabelConnectorLineVisibility(visible);
...
void qMRMLMarkupsDisplayNodeWidget::onConnectorLineScaleSliderWidgetChanged(double value)
{
  ...
  d->MarkupsDisplayNode->SetLabelConnectorLineScale(value);
}
